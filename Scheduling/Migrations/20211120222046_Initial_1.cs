        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecialistNameId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_AspNetUsers_SpecialistNameId",
                        column: x => x.SpecialistNameId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "Date", "Specialist", "SpecialistNameId", "Time", "UserId", "UserNameSurname" },
                values: new object[] { 1, "01.01.0001 0:00:00", "", null, "08:00", null, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_SpecialistNameId",
                table: "Reservations",
                column: "SpecialistNameId");
